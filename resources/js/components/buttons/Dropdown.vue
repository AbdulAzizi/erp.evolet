        ...
        <v-card>
            ...
            <div v-for="(item, key) in localItems" :key="'item-' + key">
                <v-layout
                    py-2
                    px-3
                    :class="item.read_at == null ? 'grey lighten-3' : 'white'"
                >
                    <v-flex xs1>
                        <v-avatar size="40">
                    ...
                    <v-flex xs11>
                        <div class="ml-4 caption">
                            ...
                            <span
                                v-html="item.data.link"
                                @click="markAsRead(item, false)"
                            ></span>
                        ...
                        <h6 class="ml-4 caption grey--text">
                        ...
                        <v-tooltip bottom>
                            <template v-slot:activator="{ on }">
                                <v-btn
                                    ...
                                    v-on="on"
                                >
                                    <v-icon x-small v-if="item.read_at"
                            ...
                            <span v-if="item.read_at"
                                >Отметить как непрочитанное</span
                            >
...
export default {
    ...
    created() {
        Echo.private("App.User." + this.auth.id).notification(notification => {
            ...
            let promise =
                this.muted == 1 ? this.sound.pause() : this.sound.play();
