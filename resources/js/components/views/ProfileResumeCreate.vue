<template>
    <div>
        ...
        <v-form ref="form" method="POST" :action="appPath(`users/${user.id}/cv`)">
            ...
            <template>
              <v-dialog v-model="jobDialog" width="800">
                <v-card class="pa-3">
                  <v-card-title class="mb-3">
            ...
            <template>
              <v-dialog v-model="languageDialog" width="800">
                <v-card>
                  <v-card-title>
                    <h3>Добавить язык</h3>
                  </v-card-title>
            ...
            <v-flex xs5 class="mb-3">
              ...
              <v-container
                v-for="(achievment, index) in achievments"
                v-bind:key="index"
                class="pa-0 mb-3"
              >
                <v-flex>
            ...
            <template>
              <v-dialog v-model="achievmentDialog" width="800">
                <v-card>
                  <v-card-title>
