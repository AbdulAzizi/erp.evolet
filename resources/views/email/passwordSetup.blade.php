                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin-bottom: 100px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Вы были успешно зарегистрированны в Программе по Управлению Рабочими
                                Процессами Evolet, для того чтобы установить пароль и войти в систему нажмите на кнопку:
                            </p>
                        </td>
                    </tr>
                    <tr>
