...
class FieldTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $forma_kp_pk_etap_1->fields()->attach([
            ...
            $thchp->id => ['required' => false],
            $class_pd->id => ['required' => true],
            $atx->id => ['required' => true],
            $prognoz_s->id => ['required' => false],
            ...
            $gp_stk_pk->id => ['required' => false],
            $gp_byu->id => ['required' => false],
            $p_mt->id => ['required' => false],
            $prognoz_pzh->id => ['required' => false],
            $top_analogi->id => ['required' => false],
            $pv_n->id => ['required' => false],
            $vozrast_pol->id => ['required' => true],
            $komm->id => ['required' => false],
            $drug_classification->id => ['required' => false]
        ]);
        ...
        $forma_no_etap_1->fields()->attach([
            ...
            $kppr->id => ['required' => false],
            $kprr->id => ['required' => false],
            $bgG->id => ['required' => false],
            $dolya_bg->id => ['required' => false],
            $dolya_mst->id => ['required' => false],
            $dolya_in->id => ['required' => false],
            $prir_mst->id => ['required' => false],
            $nkpf->id => ['required' => false],
            ...
            $s_knk_2_dl->id => ['required' => false],
            $s_knk_2_ns->id => ['required' => false],
            $br_knk_2->id => ['required' => false],
            $pzh_up_knk2->id => ['required' => false],
            $ko_str_knk2->id => ['required' => false],
            $s_knk_3_dl->id => ['required' => false],
            $s_knk_3_ns->id => ['required' => false],
            $br_knk_3->id => ['required' => false],
            $pzh_up_knk_3->id => ['required' => false],
            $ko_str_knk_3->id => ['required' => false],
            $s_knk_4_dl->id => ['required' => false],
            $s_knk_4_ns->id => ['required' => false],
            $br_knk_4->id => ['required' => false],
            $pzh_up_knk_4->id => ['required' => false],
            $ko_str_knk_4->id => ['required' => false],
